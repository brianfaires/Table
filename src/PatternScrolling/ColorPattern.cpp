...
uint8_t ColorPattern::numColors;
uint8_t ColorPattern::colorPeriod;
PaletteManager* ColorPattern::pm;
GammaManager* ColorPattern::Gamma;
...
void ColorPattern_Gradient::Draw(CRGB* outputArray) {
...
void ColorPattern_Blocks::Draw(CRGB* outputArray) {
